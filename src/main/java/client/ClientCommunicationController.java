...
public class ClientCommunicationController {
  ...
  /**
   * Receives a clientController object and then try to connect with the server. Constructs a
   * buffer, ClientSender and a ClientReceiver Object. Then starts two Threads.
   *
  ...
  private class ClientReceiver extends Thread {
    ...
    /**
     * Tries to open an Input Stream then tries to read an object from the stream. Then checks the
     * object's class value and sends it to {@link ClientController}.
     */
    public void run() {
      while (oisIsNull) {
        try {
