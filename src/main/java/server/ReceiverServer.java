...
public class ReceiverServer {
  ...
  /**
   * Receives all necessary data and starts the server and then generates and starts the thread
   * pool.
   *
   ...
   */
  public ReceiverServer(int port, HashMap<String, SocketStreamObject> socketHashMap,
  ...
  private class ClientHandler extends Thread {
    ...
    /**
     * Reads an object from the input stream and checks its value and send it to
